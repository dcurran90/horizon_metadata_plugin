...
(function() {
  ...
  describe('horizon.dashboard.project.containers_with_meta containers controller', function() {
    ...
    beforeEach(module('horizon.dashboard.project.containers_with_meta', function($provide) {
      $provide.value('horizon.dashboard.project.containers_with_meta.containers-model', fakeModel);
    }));
    ...
    function createController() {
      return controller(
        'horizon.dashboard.project.containers_with_meta.ContainersController', {
          'horizon.dashboard.project.containers_with_meta.baseRoute': 'base ham',
          'horizon.dashboard.project.containers_with_meta.containerRoute': 'eggs '
        });
    }
