...
(function() {
   ...
   */
  angular
    .module('horizon.dashboard.project.containers_with_meta', ['ngRoute'])
    .config(config);
  ...
  function config($provide, $routeProvider, $windowProvider) {
    ...
    $provide.constant('horizon.dashboard.project.containers_with_meta.containerRoute', containerRoute);
